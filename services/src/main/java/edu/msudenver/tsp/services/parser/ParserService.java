...
class ParserService
{
    ...
    private void recurse(Node current)
    {
        int iContain;
    ...
    public ArrayList<String> retrieveStatements(Node tree)
    {
    ...
    private ArrayList<String> traverse(Node node, ArrayList<String> stmts)
    {
    ...
    public void retrieveDefinitions(ArrayList<String> list)
    {
